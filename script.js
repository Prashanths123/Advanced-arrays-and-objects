...
const concatenatedString = alphabets.reduce((accumulator, currentValue) => accumulator + currentValue);
...
console.log("Has Bike:", hasBike); // true (assuming the bike property is in the object)
console.log("Has House:", hasHouse); // false (assuming the house property is not in the object)

// 3. Using dot and bracket notation get the output as "Mr Ajay Kumar travels by plane called Air123".
const travelInfo = `Mr ${person.name} travels by ${person.vehicles.plane} called Air123`;
